            ...
            <div className="max-w-screen-2xl mx-auto px-4 sm:px-10">
                <div className="space-y-6 py-10">
                    <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
                        {/*//! Left Side  */}
                        <div className="flex flex-col items-start justify-start gap-5 ml-20 -mt-10">
                        ...
                        {/*//! Right  */}
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6 -mt-20">
                            <div>
                                    ...
                                    {/* <li>
                                        <div className="flex flex-col">
                                            <p className="flex items-center text-gray-700 transition">
                                                ...
                                                <span className="ml-2">
                                                    <a target="_blank" className="hover:text-[#ff5a1f]" href="tel:9802121033">+977-9802121033,</a>
                                                    <a target="_blank" className="hover:text-[#ff5a1f]" href="tel:9849623247">+977-9849623247</a>
                                                </span>
                                            </p>
                                        </div>
                                    </li> */}
                                    {/* <li>
                                        <div className="flex flex-col">
                                            <p className="flex items-center text-gray-700 transition">
                                                ...
                                                <span className="ml-2">
                                                    <a target="_blank" className="hover:text-[#ff5a1f]" href="https://wa.me/9779802121033">+977-9802121033,</a>
                                                    <a target="_blank" className="hover:text-[#ff5a1f]" href="https://wa.me/9849623247">+977-9849623247</a></span>
                                            </p>
                                        </div>
                                    </li> */}
                                    <li>
