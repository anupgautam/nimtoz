        ...
        <>
                        ...
                        <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white">
                            ...
                            <li>
                                ...
                                <div
                                    ...
                                    className={`z-10 font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 ${isDropdownOpen ? '' : 'hidden'
                                        }`}
                                >
            ...
            <nav className="bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <a href="#" className="flex items-center space-x-3 rtl:space-x-reverse">
                        <img src="https://flowbite.com/docs/images/logo.svg" className="h-8" alt="Flowbite Logo" />
                        <span className="self-center text-2xl font-semibold whitespace-nowrap ">Nimto</span>
                    </a>
                    {/* Mobile Menu Button */}
                    <button
                    ...
                    <div className={`${isMobileMenuOpen ? 'block' : 'hidden'} w-full md:block md:w-auto`} id="navbar-dropdown">
                        <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white">
                            ...
                            <li className="relative">
                                ...
                                <div
                                    id="dropdownNavbar"
                                    className={`absolute z-10 mt-2 w-44 bg-white divide-y divide-gray-100 rounded-lg shadow-lg ${isDropdownOpen ? '' : 'hidden'}`}
                                >
                                    <ul className="py-2 text-sm text-gray-700 dark:text-gray-400" aria-labelledby="dropdownNavbarLink">
                                        <li>
                                            <a href="#" className="block px-4 py-2 hover:bg-gray-100 ">Hotels</a>
                                        </li>
                                        <li>
                                            <a href="#" className="block px-4 py-2 hover:bg-gray-100 ">Banquets</a>
                                        </li>
                                        <li>
                                            <a href="#" className="block px-4 py-2 hover:bg-gray-100 ">Resorts</a>
                                        </li>
                                        <li>
                                            <a href="#" className="block px-4 py-2 hover:bg-gray-100 ">Restaurants</a>
                                        </li>
                                        <li>
                                            <a href="#" className="block px-4 py-2 hover:bg-gray-100 ">Garden View</a>
                                        </li>
                                    </ul>
                                    {/* <div className="py-1">
                                        <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Sign out</a>
