        ...
        <div className="max-w-[50rem] flex flex-col mx-auto h-screen">
            <header className="mb-auto flex justify-center z-50 w-full py-4">
                <nav className="px-4 sm:px-6 lg:px-8">
                    <Link className="flex-none text-xl font-semibold sm:text-3xl" href="/" aria-label="Brand">Nimtoz</Link>
                </nav>
            </header>

            <main id="content" className="flex-grow flex flex-col items-center justify-center">
